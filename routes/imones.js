...
router.get("/", middleware.isLoggedIn, function(req, res){
    ...
    Imones.find({doc:"imone"}, function(err, allimones){
       if(err){
           console.log(err);
       } else {
           ...
           res.render("imones/index",{allimones:allimones});
       }
    });
});
...
router.post("/", middleware.isLoggedIn, function(req, res){
    ...
    var newImone = {imonessutrumpkodas: imonessutrumpkodas, imonespavadinimas: imonespavadinimas, imonesimkodas: imonesimkodas, imonespvmkodas:imonespvmkodas, imonesadresas:imonesadresas, author:author,doc:doc}
...
router.get("/:id", function(req, res){
    ...
    Imones.findById(req.params.id, function(err, foundimone){
        if(err){
            ...
            res.render("imones/show", {imone: foundimone});
        }
    });
});
...
router.get("/:id/edit", middleware.checkimonesOwnership, function(req, res){
    Imones.findById(req.params.id, function(err, foundimone){
        res.render("imones/edit", {imone: foundimone});
    });
});
